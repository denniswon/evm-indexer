...
func ProcessBlockContent(client *ethclient.Client, block *types.Block, _db *gorm.DB, queue *q.BlockProcessorQueue, status *d.StatusHolder, startingAt time.Time) bool {
